...
<?php echo $this->Form->create('Retur'); ?>
	<fieldset>
		<legend><?php echo __('Edit Retur'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Retur.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Retur.id'))); ?></li>
