...
<div class="widget-container">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('<i class="fa fa-trash-o"></i>'), array('action' => 'delete', $pembelian['Pembelian']['nomor']),  array('escape' => false,'class'=>'btn btn-danger btn-xs'), __('Are you sure you want to delete No. Nota # %s?', $pembelian['Pembelian']['nomor'])); ?>
		</td>	</tr>
<?php endforeach; ?>
	</tbody>
	</table>
