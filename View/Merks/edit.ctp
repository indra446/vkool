	...
	<div class="form-group">
		...
		<div class=" col-md-8">
			<?php 		echo $this->Form->input('id');
			 echo $this -> Form -> input('parent_id', array('class' => 'form-control', 'label' => false, 'options' => $parentMerks, 'empty' => '')); ?>
		</div>
	</div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class=" col-md-8">
            <label class="col-md-8 checkbox-toggle">
                ...
                <input type="checkbox" name="data[Merk][aktif]" value="1" <?php if($edit['Merk']['aktif']==1){ echo "checked";}?>>
                <i></i></label>		</div>		
    </div>
