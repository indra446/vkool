...
jq(document).ready(function() {    // "use strict";
    ...
    if (jq.noty) {
        var n_dom = [];
            n_dom[0] = '<div class="activity-item"> <i class="zmdi zmdi-alert-polygon"></i> <div class="activity"> <?php echo $message ?> <span>Error</span> </div> </div>',
