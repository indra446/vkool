<ul class="list-accordion">
    ...
    <li><?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'zmdi zmdi-shopping-cart-plus')) . "<span class='list-label'>Pembelian</span>", array('controller' => 'Pembelians', 'action' => 'index'), array('escape' => false)); ?>  </li>
