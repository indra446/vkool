...
<div class="box box-danger">
	...
	<div class="box-body">
		...
		<div class="control-group unit">
			...
			<div class="controls">
				<?php echo $this -> Form -> input('karyawan_id', array('class' => 'form-control select2', 'options' => $karyawan,'selected'=>$dataedit['User']['karyawan_id'], 'empty' => '>> Pilih Karyawan <<', 'label' => false, 'class' => 'form-control')); ?>
