...
jq(document).ready(function() {    // "use strict";
    ...
    if (jq.noty) {
        var n_dom = [];
            n_dom[0] = '<div class="activity-item"> <i class="zmdi zmdi-check-all"></i> <div class="activity"> <?php echo $message ?> <span>Success</span> </div> </div>',
