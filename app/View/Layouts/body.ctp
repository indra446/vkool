...
<html>
	...
	<head>
		...
		<title><?php echo ucwords(strtolower(str_replace("_", " ", $_title))); ?></title>
		...
		<div class="page-header filled full-block light">
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<h2><?php echo ucwords(strtolower(str_replace("_", " ", $_title))); ?></h2>
					<p>
						<?php echo $params['action']; ?>
					</p>
				</div>
				<div class="col-md-6 col-sm-6">
					<ul class="list-page-breadcrumb">
						...
						<li>
							<?php echo $this -> Html -> link(ucwords(strtolower(str_replace("_", " ", $_title)))." ".$this -> Html -> tag('i', '', array('class' => 'zmdi zmdi-chevron-right')), array('controller' => $params['controller'],'action'=>'index'), array('escape' => false)); ?>
						</li>
