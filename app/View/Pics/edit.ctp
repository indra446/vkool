...
<?php echo $this->Form->create('Pic'); ?>
	<fieldset>
		<legend><?php echo __('Edit Pic'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Pic.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Pic.id'))); ?></li>
