<div class="vendors form">
    ...
    <div class="form-group unit">
        ...
        <div class=" col-md-8">
            <?php echo $this->Form->input('nama_vendor', array('class' => 'form-control', 'label' => false, 'required' => true)); ?>
        </div>
    </div>	
    <div class="form-group unit">
        <label class="col-md-2 control-label">Alamat Vendor</label>
        <div class=" col-md-8">
            <?php echo $this->Form->textarea('alamat', array('class' => 'form-control', 'label' => false, 'required' => true)); ?>
        </div>
    </div>	
    <div class="form-group unit">
