...
$(document).ready(function() {
 $('#add_produk').on('click', function(){
         ...
         var qty = parseInt($("#PenjualanQty").val(), 10);
         var price = parseInt($("#PenjualanHarga").val(), 10);
         if(prod != "" && isNaN(qty) != true && qty > 0 && isNaN(price) != true && price > 0){
            $.ajax({
                type: "POST",
         ...
         var qty = parseInt($("#qtysamping").val(), 10);
         var price = parseInt($("#hargasamping").val(), 10);
         if(prod != "" && isNaN(qty) != true && qty > 0 && isNaN(price) != true && price > 0){
            $.ajax({
                type: "POST",
        ...
        //belakang//
         ...
         var qty = parseInt($("#qtybelakang").val(), 10);
         var price = parseInt($("#hargabelakang").val(), 10);
         if(prod != "" && isNaN(qty) != true && qty > 0 && isNaN(price) != true && price > 0){
            $.ajax({
                type: "POST",
        ...
        //aksesoris//
         ...
         var qty = parseInt($("#qtyaksesoris").val(), 10);
         var price = parseInt($("#hargaaksesoris").val(), 10);
         if(prod != "" && isNaN(qty) != true && qty > 0 && isNaN(price) != true && price > 0){
            $.ajax({
                type: "POST",
        ...
        //service//
         ...
         var qty = parseInt($("#qtyservice").val(), 10);
         var price = parseInt($("#hargaservice").val(), 10);
         if(prod != "" && isNaN(qty) != true && qty > 0 && isNaN(price) != true && price > 0){
            $.ajax({
                type: "POST",
